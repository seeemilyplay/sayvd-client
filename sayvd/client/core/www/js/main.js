...
var app = new App({
  ...
  saves: saves,
  setup: setup,
  currenthabit: habits.models.length>0 ? habits.models[habits.models.length - 1] : undefined,
  currentgoal: goals.models.length>0 ? goals.models[goals.models.length - 1] : undefined
});
